...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF62E290);
  late Color secondary = const Color(0xFF1A1A1A);
  late Color tertiary = const Color(0xFF9E9E9E);
  late Color alternate = const Color(0xFFCBCBCB);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xB2101213);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF6F6F6);
  late Color accent1 = const Color(0x4C000000);
