...
class CustomDialogWidget extends StatefulWidget {
  const CustomDialogWidget({
    ...
    String? title,
    String? body,
    required this.actionOnValidation,
    String? validationLabel,
    String? cancelLabel,
  })  : this.title = title ?? 'Title',
        this.body = body ?? 'body',
        this.validationLabel = validationLabel ?? 'Valider',
        this.cancelLabel = cancelLabel ?? 'Annuler';

  final String title;
  final String body;
  final Future Function()? actionOnValidation;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await widget.actionOnValidation?.call();
                        Navigator.pop(context);
                      },
